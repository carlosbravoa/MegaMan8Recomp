...
Static recompilation of **MegaMan8** built on
[psxrecomp](https://github.com/mstan/psxrecomp) and
[recomp-ui](https://github.com/mstan/recomp-ui).

Mega Man 8 (USA, SLUS-00453) statically recompiled to a native executable with PSXRecomp.
...
Zip prefix for CI artifacts: `mm8`.

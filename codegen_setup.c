...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "MegaMan8",
    .project_root_env = "MEGAMAN8RECOMP_PROJECT_ROOT",
    .build_dir_env = "MEGAMAN8RECOMP_BUILD_DIR",
    .force_setup_env = "MEGAMAN8RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_004.53_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "MegaMan8_Recompiled",
    .prepare_note =
